        ...
        >
          <div className="bg-card rounded-2xl p-8 border border-border shadow-elevated">
            ...
            <form className="space-y-4">
              ...
              <Button
                type="submit"
                className="w-full h-12 bg-gradient-brand text-primary-foreground hover:opacity-90 shadow-brand text-lg"
              >
            ...
            <div className="grid grid-cols-1 gap-3">
              <Button variant="outline" className="h-12">
                <svg className="h-5 w-2 mr-2" viewBox="0 0 24 24">
                  <path
                    fill="currentColor"
